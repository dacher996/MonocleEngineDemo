...
{
    /// <summary>
    /// Represents a texture with multiple sprites placed on it. Along with it goes the placement of the independent sprites
    /// inside the texture, aswell their paths that can be used when creating SpriteBanks.
    /// </summary>
    public class Atlas
    {
